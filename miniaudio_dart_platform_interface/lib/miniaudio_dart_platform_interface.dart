...
base class MiniaudioDartPlatformException implements Exception {
  MiniaudioDartPlatformException([this.message]);

  final String? message;

  @override
  String toString() => message == null
      ? "MiniaudioDart platform exception"
      : "MiniaudioDart platform exception: $message";
}

final class MiniaudioDartPlatformOutOfMemoryException
    extends MiniaudioDartPlatformException {
  MiniaudioDartPlatformOutOfMemoryException([String? message])
